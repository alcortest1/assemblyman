...
//
// AssemblyManApp.swift
//
// Main entry point for the AssemblyMan sample app demonstrating the Meta Wearables DAT SDK.
...
struct AssemblyManApp: App {
  ...
  init() {
    do {
      ...
      #if DEBUG
      NSLog("[AssemblyMan] Failed to configure Wearables SDK: \(error)")
      #endif
    }
