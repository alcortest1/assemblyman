...
*Cited by:* AM.I.C.S3 · *Located by:* search (`content search: ballast weight shift required location`) · *Pages:* 6-3, 6-4, 6-5, 6-6
...
sum of the moments on each side of the balance point must be 
...
fulcrum) located at the CG for the lever. Even though the 
weights on either side of the fulcrum are not equal, and the 
...
is contained in the aircraft weight and balance report.
Useful Load
...
## 6-5 (PDF page index 215)

```text
6-5
must ensure that no legal condition of loading can move the 
...
must be subtracted from the scale reading. Other examples of 
tare weight are wheel chocks placed on the scales and ground 
...
with datum at one end.
Figure 6-6. Center of gravity for weights on a plank with datum 
at one end.
columns are summed, with the CG being equal to the total 
...
includes all the pertinent specifications for the aircraft, and 
